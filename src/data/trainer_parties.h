...
static const struct TrainerMonItemCustomMoves sParty_Winona5[] = {
    ...
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_SALAMANCE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FLAMETHROWER, MOVE_FLY, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_RETURN, MOVE_SURF, MOVE_HYPER_BEAM}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_WING_ATTACK, MOVE_CRUNCH, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEEL_WING, MOVE_SPIKES, MOVE_TOXIC, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WING_ATTACK, MOVE_CRUNCH, MOVE_CONFUSE_RAY, MOVE_SLUDGE_BOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza5[] = {
    ...
    .species = SPECIES_HYPNO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WISH, MOVE_HELPING_HAND, MOVE_THUNDER_WAVE, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 64,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_METEOR_MASH, MOVE_ROCK_SLIDE, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 63,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SURF, MOVE_CALM_MIND, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_HYPNOSIS, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_PROTECT, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_DRILL_PECK, MOVE_SPIKES, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPIKES, MOVE_RAPID_SPIN, MOVE_REST, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SUBSTITUTE, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_ROAR, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_SUPERSONIC, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 80,
